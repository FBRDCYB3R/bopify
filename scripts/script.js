...
$.ajax({
  ...
  success: function(data){
	...
	vueInit();
        var cl = new Image(500,500); cl.src = trackList[0].cover; cl.onload = ()=>{$("body").css({background: `radial-gradient(gray, rgb(${String(colors.getColor(cl))}))`}); console.log(String(colors.getColor(cl)));};
  }
});
